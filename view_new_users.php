...
$countQuery = "SELECT COUNT(*) as total FROM new_users $where";
$total = $conn->query($countQuery)->fetch_assoc()['total'];
$totalPages = ceil($total / $limit);

$query = "SELECT * FROM new_users $where ORDER BY email DESC LIMIT $limit OFFSET $offset";
...
<body>
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
            <div>
                <h2><i class="fas fa-user-check"></i> New Users (<?php echo $total; ?>)</h2>
            </div>
        ...
        <div class="card">
                        ...
                        <tbody>
                            <?php while($row = $res->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td data-label="Referred By"><?php echo htmlspecialchars($row['referred_by'] ?? 'Direct'); ?></td>
                                    <td data-label="Relation"><?php echo htmlspecialchars($row['relation']); ?></td>
                                <td data-label="Registered">N/A</td>
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 60px 20px; color: #666;">
                    ...
                    <h3>No New Users Yet</h3>
                    <p style="margin-bottom: 25px;">Be the first to register through the referral program!</p>
